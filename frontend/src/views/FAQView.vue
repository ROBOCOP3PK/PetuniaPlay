  ...
  <div class="min-h-screen bg-white dark:bg-gray-900 py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <template v-if="isLoading">
        <!-- Search Box Skeleton -->
        <div class="mb-8">
          <div class="h-12 bg-gray-300 dark:bg-gray-700 rounded-lg animate-pulse"></div>
        </div>

        <!-- Categories Skeleton -->
        <div class="flex flex-wrap gap-3 mb-8">
          <div v-for="n in 6" :key="`cat-skeleton-${n}`" class="h-10 w-32 bg-gray-300 dark:bg-gray-700 rounded-lg animate-pulse"></div>
        </div>

        <!-- FAQ Accordion Skeleton -->
        <div class="space-y-4">
          <div v-for="n in 5" :key="`faq-skeleton-${n}`" class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border border-gray-200 dark:border-gray-700 p-6 animate-pulse">
      ...
      <template v-else>
        ...
        <div class="space-y-4">
          ...
          >
            <button
              ...
              class="w-full text-left px-6 py-4 flex justify-between items-center hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200"
            >
        ...
        <div class="mt-12 bg-gradient-to-r from-primary to-primary-light dark:from-primary-dark dark:to-primary text-white rounded-lg p-8 text-center">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <router-link
              to="/contact"
              class="inline-block bg-white text-primary dark:text-primary-dark px-8 py-3 rounded-lg font-semibold hover:bg-opacity-90 transition-all duration-200"
            >
              Contáctanos
            </router-link>
            <a
              href="mailto:contacto@petuniaplay.com"
              class="inline-block bg-white bg-opacity-20 text-white px-8 py-3 rounded-lg font-semibold hover:bg-opacity-30 transition-all duration-200 border-2 border-white"
            >
              Enviar Email
            </a>
          </div>
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Sí, ofrecemos <strong>envío gratis en Bogotá</strong> cuando:<br><br><ul class="list-disc list-inside space-y-1"><li>Compras <strong>4 o más productos</strong></li><li>Solicitas entrega nocturna (entre 9:00 PM y 2:00 AM)</li></ul><br>Para pedidos que no cumplan estas condiciones, se aplica una tarifa estándar de <strong>$10,000 COP</strong>.`
  },
  {
    category: 'Pedidos y Envíos',
...
// Simular carga inicial para consistencia con el sistema
onMounted(() => {
  setTimeout(() => {
