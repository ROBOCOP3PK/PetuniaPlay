  ...
  <AdminLayout>
    <div class="space-y-6">
      ...
      <div>
        ...
        <p class="text-gray-600 mt-1">Administra la configuración general del sitio web</p>
      </div>
          ...
          <div class="border-b pb-6">
            ...
            <div v-if="config.whatsapp_enabled" class="space-y-4">
              ...
              <div class="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                <p class="text-sm font-semibold text-green-800 mb-2">Vista Previa del Enlace:</p>
                <p class="text-xs text-green-700 break-all font-mono">
                ...
                <a
                  ...
                  class="mt-2 inline-flex items-center gap-2 text-sm text-green-600 hover:text-green-700 font-semibold"
                >
