  ...
  <AdminLayout>
    <div class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-3xl font-bold text-gray-900">Gestión de Cupones</h1>
          <p class="text-gray-600 mt-1">Administra códigos de descuento y promociones</p>
        </div>
        <button
          @click="openModal()"
      ...
      <div v-if="stats" class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm text-gray-600 mb-1">Cupones Activos</p>
              <p class="text-3xl font-bold text-green-600">{{ stats.active_coupons }}</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm text-gray-600 mb-1">Usos Totales</p>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm text-gray-600 mb-1">Más Usado</p>
              <p class="text-lg font-bold text-orange-600">{{ stats.most_used[0]?.code || 'N/A' }}</p>
              <p class="text-sm text-gray-500">{{ stats.most_used[0]?.usage_count || 0 }} usos</p>
            </div>
      ...
      <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div v-else-if="coupons.length === 0" class="text-center py-12">
          ...
          <p class="mt-2 text-gray-600">No se encontraron cupones</p>
        </div>
        ...
        <table v-else class="w-full">
          <thead class="bg-gray-50 border-b">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Mín. Compra</th>
          ...
          <div class="inline-block w-full max-w-2xl my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
            ...
            <form @submit.prevent="saveCoupon" class="px-6 py-4">
              <div class="space-y-4">
                <!-- Code -->
                <div>
                  <label class="block text-sm font-semibold mb-2">Código del Cupón *</label>
                  <input
                ...
                <!-- Min Purchase Amount -->
                <div>
                  <label class="block text-sm font-semibold mb-2">Monto Mínimo de Compra ($)</label>
                  <input
                    ...
                    placeholder="100000"
                  />
                  <p class="text-xs text-gray-500 mt-1">Deja vacío si no hay monto mínimo</p>
                </div>

                <!-- Usage Limit -->
                <div>
                  <label class="block text-sm font-semibold mb-2">Límite de Usos</label>
                  <input
                    ...
                    placeholder="100"
                  />
                  <p class="text-xs text-gray-500 mt-1">Deja vacío para usos ilimitados</p>
                </div>

                <!-- Valid Dates -->
                <div class="grid grid-cols-2 gap-4">
                  <div>
                    <label class="block text-sm font-semibold mb-2">Válido Desde</label>
                    <input
                  ...
                  <div>
                    <label class="block text-sm font-semibold mb-2">Válido Hasta</label>
                    <input
                ...
                <div class="flex items-center">
                  <input
                    ...
                    class="mr-2"
                  />
                  <label for="is_active" class="text-sm font-semibold">Cupón Activo</label>
                </div>
              </div>
